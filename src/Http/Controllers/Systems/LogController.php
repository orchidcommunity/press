...
class LogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cms::container.systems.logs.logs', compact('headers', 'rows', 'footer'));
    }
    ...
    public function dashboard()
    {
        ...
        return view('cms::container.systems.logs.index', compact('chartData', 'percents'));
    }
    ...
    public function show($date)
    {
        ...
        return view('cms::container.systems.logs.show', compact('log', 'levels', 'entries'));
    }
