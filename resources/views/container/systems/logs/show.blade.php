                            ...
                            <div class="panel ">
                                ...
                                @if ($entries->hasPages())
                                    <footer class="panel-footer">
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <small class="text-muted inline m-t-sm m-b-sm">{{trans('cms::common.show')}} {{$entries->total()}}
                                                    -{{$entries->perPage()}} {{trans('cms::common.of')}} {!! $entries->count() !!} {{trans('cms::common.elements')}}</small>
                                            </div>
