<div class="dropzone" id="real-dropzone">
    ...
    <div class="dz-message">
        <hr>
        <p class="font-bold">{{trans('cms::post/post.upload.title')}}</p>
        <small>{{trans('cms::post/post.upload.description')}}</small>
    </div>
</div>
        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                <div class="modal-header clearfix text-left">
                    ...
                    <h5>{{trans('cms::post/post.upload.information.title')}}</h5>
                    <p class="m-b-md">{{trans('cms::post/post.upload.information.sub_title')}}</p>
                </div>
                        ...
                        <div class="col-sm-10 col-sm-offset-1">
                            <div class="wrapper">
                                ...
                                <div class="form-group">
                                    <label>{{trans('cms::post/post.upload.information.system_name')}}</label>
                                    <input type="text" class="form-control" v-model="attachment[active].name" readonly
                                           maxlength="255"
                                           placeholder="{{trans('cms::post/post.upload.information.system_name')}}">
                                </div>
                                <div class="form-group">
                                    <label>{{trans('cms::post/post.upload.information.name')}}</label>
                                    <input type="text" class="form-control" v-model="attachment[active].original_name"
                                           maxlength="255"
                                           placeholder="{{trans('cms::post/post.upload.information.name')}}">
                                </div>
                                <div class="form-group">
                                    <label>{{trans('cms::post/post.upload.information.alt')}}</label>
                                    <input type="text" class="form-control" v-model="attachment[active].alt"
                                           maxlength="255"
                                           placeholder="{{trans('cms::post/post.upload.information.alt')}}">
                                </div>
                                <div class="form-group">
                                    <label>{{trans('cms::post/post.upload.information.description')}}</label>
                                    <textarea class="form-control no-resize" v-model="attachment[active].description"
                                              placeholder="{{trans('cms::post/post.upload.information.description')}}"
                                              maxlength="255"
                                              rows="3"></textarea>
                                </div>
                                ...
                                <p class="text-right">
                                    <button type="button" v-on:click="save"
                                            class="btn btn-default">{{trans('cms::common.Apply')}}</button>
                                </p>
