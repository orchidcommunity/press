<div class="wrapper-md">
    ...
    <div class="form-group m-t-md">
        <label class="col-sm-2 control-label">{{trans('cms::marketing/advertising.name')}}</label>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">{{trans('cms::marketing/advertising.category')}}</label>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">{{trans('cms::marketing/advertising.period')}}</label>
